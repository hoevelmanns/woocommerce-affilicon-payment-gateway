...
class WC_Affilicon_Payment_Gateway extends WC_Payment_Gateway
{
    ...
    public function process_payment($orderId)
    {
        ...
        $affiliconRequest = new WC_Affilicon_Payment_Gateway_Request($this);

        $testurl = $affiliconRequest->widgetFormUrl();


        /* later, for legacy support
        return array(
            'result' => 'success',
            'redirect' => $affiliconRequest->legacyFormUrl($order) //@todo testmodus berücksichtigen
        );
        */
